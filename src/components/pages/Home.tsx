    ...
    <div className="relative w-full bg-ryancv-sidebar overflow-hidden rounded-md">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full p-4 md:p-10 mt-[100px] md:mt-[150px]">
        ...
        <div className="relative mb-4">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-white mt-4">{Personal.name}</h1>
          <Type />
        </div>
        ...
        {/* Buttons */}
        <div className="flex justify-center gap-4 md:gap-6 mt-auto w-[100%] border-t border-[#3d3d3d] pt-4 md:pt-6">
          <a
            href={Personal.resumePath}
            download
            className="px-4 md:px-6 hoverable py-2 bg-ryancv-sidebar text-white uppercase font-semibold text-sm flex items-center gap-2 hover:text-ryancv-yellow transition-all duration-300 rounded hover:scale-110"
          >
            <span>Download CV</span>
            <span className="text-xs">+</span>
          </a>
          <div className="h-8 md:h-10 border-r border-[#3d3d3d]"></div>
          <a
            href={Personal.contactLink}
            className="px-4 md:px-6 py-2 bg-ryancv-sidebar text-white uppercase font-semibold text-sm flex items-center gap-2 hover:text-ryancv-yellow transition-all duration-300 rounded hover:scale-110"
          >
